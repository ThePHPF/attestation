...
use ThePhpFoundation\Attestation\Verification\GmpEcdsaDigestVerifierBackend;
...
/** @covers \ThePhpFoundation\Attestation\Verification\GmpEcdsaDigestVerifierBackend */
final class GmpEcdsaDigestVerifierBackendTest extends TestCase
{
    ...
    public function testVerifiesAValidP256SignatureAgainstItsDigest(): void
    {
        ...
        self::assertTrue((new GmpEcdsaDigestVerifierBackend())->verify(self::CURVE_P256, hash('sha256', 'signed content', true), $rHex, $sHex, $qx, $qy));
    }
    ...
    public function testRejectsAP256SignatureAgainstADigestOfDifferentContent(): void
    {
        ...
        self::assertFalse((new GmpEcdsaDigestVerifierBackend())->verify(self::CURVE_P256, hash('sha256', 'different content', true), $rHex, $sHex, $qx, $qy));
    }
    ...
    public function testRejectsAValidP256SignatureAgainstTheWrongPublicKey(): void
    {
        ...
        self::assertFalse((new GmpEcdsaDigestVerifierBackend())->verify(self::CURVE_P256, hash('sha256', 'signed content', true), $rHex, $sHex, $wrongQx, $wrongQy));
    }
    ...
    public function testVerifiesAValidP384SignatureAgainstItsDigest(): void
    {
        ...
        self::assertTrue((new GmpEcdsaDigestVerifierBackend())->verify(self::CURVE_P384, hash('sha384', 'signed content', true), $rHex, $sHex, $qx, $qy));
    }
    ...
    public function testRejectsAP384SignatureAgainstADigestOfDifferentContent(): void
    {
        ...
        self::assertFalse((new GmpEcdsaDigestVerifierBackend())->verify(self::CURVE_P384, hash('sha384', 'different content', true), $rHex, $sHex, $qx, $qy));
    }
    ...
    public function testRejectsAValidP384SignatureAgainstTheWrongPublicKey(): void
    {
        ...
        self::assertFalse((new GmpEcdsaDigestVerifierBackend())->verify(self::CURVE_P384, hash('sha384', 'signed content', true), $rHex, $sHex, $wrongQx, $wrongQy));
    }
}
